...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx497ca94cbbd1d946",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'b518f109522b82073db77f2f96646314',
  ...
  USERS: [
    {
      ...
      openUrl: 'https://www.xzw.com/fortune/',  //星座
      ...
      festivals: [
        ...
        {
          type: '生日', name: '你', year: '2002', date: '01-01',
        },
        {
  ...
  FESTIVALS: [
    ...
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
    {
      type: '生日', name: '你', year: '2002', date: '01-01', isShowAge: true,
    },
    {
